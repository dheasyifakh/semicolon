    ...
    <div class="grid grid-cols-1 lg:h-screen lg:grid-cols-2">
      ...
      <div class="relative flex items-center bg-gray-100">
        ...
        <div class="p-8 sm:p-16 lg:p-24">
            <h2 class="text-3xl font-bold sm:text-4xl">Let's Find & Booking Your <span className="text-primary">Therapist</span></h2>
          ...
          <Link
            href='/login'
            class="mt-8 inline-block rounded border border-primary bg-primary px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500"
          >
            Get in Touch
          </Link>
        </div>
